...
//                "\t\t\t<vmap:AdTagURI templateType=\"vast3\">\n" +
//                "\t\t\t\t<![CDATA[\n" +
//                "https://pubads.g.doubleclick.net/gampad/ads?slotname=/124319096/external/ad_rule_samples&sz=640x480&ciu_szs=300x250&cust_params=deployment%3Ddevsite%26sample_ar%3Dpremidpostpod&url=&unviewed_position_start=1&output=xml_vast3&impl=s&env=vp&gdfp_req=1&ad_rule=0&cue=15000&vad_type=linear&vpos=midroll&pod=2&mridx=1&rmridx=1&ppos=1&min_ad_duration=0&max_ad_duration=30000&vrid=6376&video_doc_id=short_onecue&cmsid=496&kfa=0&tfcd=0\n" +
//                "]]>\n" +
//                "\t\t\t</vmap:AdTagURI>\n" +
//                "\t\t</vmap:AdSource>\n" +
//                "\t</vmap:AdBreak>\n" +
...
//                "\t\t\t<vmap:AdTagURI templateType=\"vast3\">\n" +
//                "\t\t\t\t<![CDATA[\n" +
//                "https://pubads.g.doubleclick.net/gampad/ads?slotname=/124319096/external/ad_rule_samples&sz=640x480&ciu_szs=300x250&cust_params=deployment%3Ddevsite%26sample_ar%3Dpremidpostpod&url=&unviewed_position_start=1&output=xml_vast3&impl=s&env=vp&gdfp_req=1&ad_rule=0&cue=15000&vad_type=linear&vpos=midroll&pod=2&mridx=1&rmridx=1&ppos=3&lip=true&min_ad_duration=0&max_ad_duration=30000&vrid=6376&video_doc_id=short_onecue&cmsid=496&kfa=0&tfcd=0\n" +
//                "]]>\n" +
//                "\t\t\t</vmap:AdTagURI>\n" +
//                "\t\t</vmap:AdSource>\n" +
//                "\t</vmap:AdBreak>\n" +
...
//                "\t\t\t<vmap:AdTagURI templateType=\"vast3\">\n" +
//                "\t\t\t\t<![CDATA[\n" +
//                "https://pubads.g.doubleclick.net/gampad/ads?slotname=/124319096/external/ad_rule_samples&sz=640x480&ciu_szs=300x250&cust_params=deployment%3Ddevsite%26sample_ar%3Dpremidpostpod&url=&unviewed_position_start=1&output=xml_vast3&impl=s&env=vp&gdfp_req=1&ad_rule=0&vad_type=linear&vpos=postroll&pod=3&ppos=1&lip=true&min_ad_duration=0&max_ad_duration=30000&vrid=6376&video_doc_id=short_onecue&cmsid=496&kfa=0&tfcd=0\n" +
//                "]]>\n" +
//                "\t\t\t</vmap:AdTagURI>\n" +
//                "\t\t</vmap:AdSource>\n" +
//                "\t</vmap:AdBreak>\n" +
//                "</vmap:VMAP>");
//        adsLoader = new ImaAdsLoader.Builder(context).buildForAdTag(Uri.parse("https://www.thekirankumar.com/blog/vast/vmap.xml"));

        adsLoader = new ImaAdsLoader.Builder(context).buildForAdsResponse("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
...
//                "<vmap:Extension type=\"bumper\" suppress_bumper=\"true\"/>\n" +
                ...
                "\n");
        try {
            Field debug = adsLoader.getClass().getDeclaredField("DEBUG");
            debug.setAccessible(true);
            debug.setBoolean(adsLoader, true);
