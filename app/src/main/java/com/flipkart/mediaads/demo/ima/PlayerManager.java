...
/* package */ final class PlayerManager implements AdsMediaSource.MediaSourceFactory {
    ...
    public PlayerManager(Context context, String url, String response) {
...
//                "<vmap:Extension type=\"bumper\" suppress_bumper=\"true\"/>\n" +
        ...
        adsLoader = new ImaAdsLoader.Builder(context).buildForAdsResponse(response);

        if (!TextUtils.isEmpty(url)) {
            adsLoader = new ImaAdsLoader.Builder(context).buildForAdTag(Uri.parse(url));
        }
        dataSourceFactory =
